...
tools: Read, Write, Edit, MultiEdit, Grep, Glob, Bash, Skill(plugin-dev:agent-development), Skill(plugin-dev:skill-development), Skill(copywriting), Skill(copy-editing), Skill(agent-browser)
model: sonnet
color: blue
---
