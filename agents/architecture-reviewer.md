...
https://github.com/b-open-io/prompts/blob/master/agents/architecture-reviewer.md
...
- `Skill(visual-review)` — turn a large diff or refactor into a visual recap page (before/after wireframes, contract changes, file map, annotated key diffs). Invoke as the opening artifact of any large-scale review so stakeholders see the shape of the change before your detailed analysis.
