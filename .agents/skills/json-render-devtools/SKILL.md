...
```bash
# React
bun add @json-render/devtools @json-render/devtools-react

# Vue
bun add @json-render/devtools @json-render/devtools-vue

# Svelte
bun add @json-render/devtools @json-render/devtools-svelte

# Solid
bun add @json-render/devtools @json-render/devtools-solid
```
