...
| `humanize` | Preserve facts and house style while removing clustered AI-writing patterns, mannered metaphor-for-statement substitutions, unsupported significance, vague attribution, promotional drift, canned change summaries, and template-like sales copy; outbound drafts use attributed examples and supplied account facts without inventing commercial claims |
