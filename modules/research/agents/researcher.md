...
description: >-
  ...
  "research this topic", "find sources on X", "summarize what people are saying about Y on
  X/Twitter", or "compare these competitors". Gathers from docs, APIs, and web sources. Not for
  implementing changes based on the research (use the relevant specialist) or growth strategy
  (use the marketer agent).
tools: WebFetch, WebSearch, Grep, Glob, Read, Write, Bash, TaskCreate, TaskUpdate, TaskGet, TaskList, Skill
color: pink
---
...
- `Skill(product-skills:geo-optimizer)` — geo-specific content and localization research.
