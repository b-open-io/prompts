...
version: 1.0.5
description: >-
  Inject compressed SKILL-MAP and AGENT-MAP directive blocks into CLAUDE.md so skill names and
  agent IDs survive a long session. Use when modifying a CLAUDE.md, when adding a skill or agent
  to a plugin, or for "update the skill map", "register this agent", "skills keep getting
  forgotten", "sync skills to CLAUDE.md".
