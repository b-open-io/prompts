...
Every plugin change must update `CHANGELOG.md`; it is a release artifact, not
an optional document. Changes to the public inventory, installation/update
flow, runtime behavior, or advertised features must also update `README.md`.
